...
VectorSimulationFitnessEvaluatorFactory::VectorSimulationFitnessEvaluatorFactory(Real timeStepValue, Real simulationTimeValue,
...
std::unique_ptr<FitnessEvaluator> VectorSimulationFitnessEvaluatorFactory::create() const
{
    return std::make_unique<VectorSimulationFitnessEvaluator>(timeStep, simulationTime, targetPointFromTargetBody, simulationFactory);
}
