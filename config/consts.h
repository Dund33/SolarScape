...
inline constexpr Real ALGO_CLOSE_TO_TARGET_WINDOW_VIOLATION = 750000.0;
...
inline constexpr double MUTATION_PROBABILITY = 0.015;
inline constexpr double NSGAII_MUTATION_PROBABILITY = 0.0067;
inline constexpr double NSGAIII_MUTATION_PROBABILITY = 0.0067;
inline constexpr double MOEAD_MUTATION_PROBABILITY = 0.05;
inline constexpr double EXTENSIVE_MUTATION_ADD_PROBABILITY = 0.015;
inline constexpr double EXTENSIVE_MUTATION_REMOVE_PROBABILITY = 0.0075;
