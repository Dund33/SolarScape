...
RUN_METRIC_LABELS = {
    ...
    "final_feasible_rate": "Final feasible Pareto-front fraction",
    "final_target_feasible": "Final target-window feasible specimens",
    "final_target_feasible_rate": "Final target-window feasible Pareto-front fraction",
    "final_mission_feasible": "Final mission-feasible specimens",
    "final_mission_feasible_rate": "Final mission-feasible Pareto-front fraction",
...
RUN_METRIC_AXIS_LABELS = {
    "final_front_size": "Pareto front size [specimens]",
    "final_feasible": "Specimens",
    "final_feasible_rate": "Feasible Pareto-front fraction [-]",
    "final_target_feasible": "Specimens",
    "final_target_feasible_rate": "Target-window feasible Pareto-front fraction [-]",
    "final_mission_feasible": "Specimens",
    "final_mission_feasible_rate": "Mission-feasible Pareto-front fraction [-]",
    ...
    "best_so_far_generation": "Generation [generation]",
